...
func TestParseFile(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			Want: []*posRef{
				{Def: Def{ImportPath: "github.com/saibing/bingo/vendor/gopkg.in/inconshreveable/log15.v2", PackageName: "log15", Path: ""}, Start: pos("testdata/unmatching-imports.go:3:8 (offset 21)"), End: pos("testdata/unmatching-imports.go:3:49 (offset 62)")},
				{Def: Def{ImportPath: "github.com/saibing/bingo/vendor/gopkg.in/inconshreveable/log15.v2", PackageName: "log15", Path: "Crit"}, Start: pos("testdata/unmatching-imports.go:6:8 (offset 124)"), End: pos("testdata/unmatching-imports.go:6:12 (offset 128)")},
			},
		},
		{
